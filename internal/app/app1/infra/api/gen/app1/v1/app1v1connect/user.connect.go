...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/pivaldi/go-cleanstack/internal/app/app1/infra/api/gen/app1/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "app1.v1.UserService"
)
...
const (
	...
	UserServiceCreateUserProcedure = "/app1.v1.UserService/CreateUser"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/app1.v1.UserService/GetUser"
	// UserServiceGetUserByEmailProcedure is the fully-qualified name of the UserService's
	// GetUserByEmail RPC.
	UserServiceGetUserByEmailProcedure = "/app1.v1.UserService/GetUserByEmail"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/app1.v1.UserService/ListUsers"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/app1.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/app1.v1.UserService/DeleteUser"
)

// UserServiceClient is a client for the app1.v1.UserService service.
...
// NewUserServiceClient constructs a client for the app1.v1.UserService service. By default, it uses
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_app1_v1_user_proto.Services().ByName("UserService").Methods()
...
// CreateUser calls app1.v1.UserService.CreateUser.
...
// GetUser calls app1.v1.UserService.GetUser.
...
// GetUserByEmail calls app1.v1.UserService.GetUserByEmail.
...
// ListUsers calls app1.v1.UserService.ListUsers.
...
// UpdateUser calls app1.v1.UserService.UpdateUser.
...
// DeleteUser calls app1.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the app1.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app1.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUserByEmail(context.Context, *connect.Request[v1.GetUserByEmailRequest]) (*connect.Response[v1.GetUserByEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.GetUserByEmail is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app1.v1.UserService.DeleteUser is not implemented"))
}
